...
export class RestProvider {
  ...
  applyCoupon(pakage, coupon_code: string) {
    ...
    return this.ahttp.get(
      this.url + "/cart/coupon" + c + s + p + cc + uid,
      {},
      {}
    );
  }
  removeCoupon(pakage, coupon_code: string) {
    ...
    let cc = coupon_code ? "&coupon_code=" + coupon_code : "";
    return this.ahttp.get(
      this.url + "/cart/remove-coupon" + c + s + p + cc,
      {},
      {}
    );
  }
  ...
  updateCart(pakage, cart_item_key: string, quantity: number) {
    ...
    return this.ahttp.get(
      this.url + "/cart/update" + c + s + p + cik + q,
      {},
      {}
    );
  }
  ...
  getReview(
    ...
    if (this.user && this.user.shipping) {
      ...
      return this.ahttp.get(
        this.url + "/checkout/review-order" + c + st + p + s + cp + uid + pw,
        {},
        {}
      );
    } else {
      ...
      let cp = chosen_payment_method
        ...
        : "";
      return this.ahttp.get(
        this.url + "/checkout/review-order" + s + cp,
        {},
        {}
      );
    }
  ...
  createOrder(payment_method, shipping_method, data = {}, pay_via_wallet?) {
    ...
    return this.ahttp.post(
      this.url + "/checkout/new-order" + u + p + c + pw,
      data,
      {}
    );
  }
